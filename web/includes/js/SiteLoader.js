...
function SiteLoader(optionArray) {
  ...
  options.loadImage = "imgs/loading.gif";
  options.loadImageClassName = "loadingImage";
  ...
  this.loadSiteEvent = function(event) {
    ...
    $(targetElement).html("<img src='"+options.loadImage+"' class='"+options.loadingImageClassName+"' alt='load' />");
